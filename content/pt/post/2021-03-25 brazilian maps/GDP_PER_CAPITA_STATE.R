...
# se colocar S no limite superior fica péssimo o gradiente, por isso usei 50.00
p = states %>% ggplot() + 
...
p = p +   labs(title = "GDP per Capita by State",caption  = "Autores: Gerson Júnior e Henrique Martins.") +
