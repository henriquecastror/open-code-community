...
3) Crie sua página de autor utilizando o seguinte template: {{% staticref "files/author_template.txt" "newtab" %}} here{{% /staticref %}}. and {{% staticref "files/autor_index.md" "newtab" %}} here {{% /staticref %}}.  
